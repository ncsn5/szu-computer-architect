...
//系统信息
extern uint32_t system_cpu_freq;//处理器频率
extern uint32_t system_cpu_freqM;//处理器频率，单位M
extern uint32_t system_iram_size;//指令存储器大小kb
extern uint32_t system_sram_size;//数据存储器大小kb
extern uint32_t system_vendorid;//Vendor ID
